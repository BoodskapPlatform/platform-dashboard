...
function loadContent(id,nam,imgpath){
    ...
    $("#dashboardTabContent").html('<iframe onload="autoResize(this)" id="parentIframe" src="'+PLATFORM_BASE_PATH + '/platform/public/dashboard/' + DOMAIN_KEY + '/' + id+'?p=1" style="width: 100%;height:'+$(window).height()*10+'px;border:0px;overflow: no-display"></iframe>');
